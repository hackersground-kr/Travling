...
import com.traveling.presentation.features.main.home.HomeViewModel.Companion.ON_CLICK_NEWS
    ...
    override fun observerViewModel() {
        ...
        bindingViewEvent { event ->
            when (event) {
                ...
                ON_CLICK_NEWS -> findNavController().navigate(R.id.action_homeFragment_to_newsFragment) //
